...
export model_name_or_path="/home/dev/mvaplm1/models/deberta-v3-base"
export model_short="deberta"
...
export lora_target_modules="query_proj,key_proj,value_proj,intermediate_dense,output_dense"
