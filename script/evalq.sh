...
export base_model_path="/home/dev/mvaplm1/models/Qwen3.5-0.8B"

# Checkpoint
export checkpoint_path="/home/dev/mvaplm1/output/wvs/celoss-jsd/qwen/Score/pdt/32/checkpoint-427"
